...
- (void)addCity {
    ...
    NSString *url = [@"https://api.openweathermap.org/data/2.5/weather?appid=c2394aa8aa8b414a1638b9cf3376b22a&q=" stringByAppendingString:self.cityNameTextField.text];
